...
const ViewStudent = ({ student, setChosedStudent }) => {
    ...
    const [startDate, setStartDate] = useState(
        (new Date(student?.start_date) || new Date()).toISOString().slice(0, 10),
    );
    ...
    const updateStudent = () => {
        ...
        axios
            .put(
                `/business/interns/${student.studentId}`,
                { appreciation_file: docx, key: student.key, start_date: startDate },
    ...
    return (
        <div className={cx('wrapper')}>
                    ...
                    <div className={cx('user-form')}>
                        ...
                        <div className={cx('user-data-item', 'full-width')}>
                            ...
                            <input
                                ...
                                id={cx('gif-input')}
                                accept=".docx"
                                onChange={(e) => handleDocxFileChange(e)}
                            />
                        </div>
                    </div>
                </div>
            ...
            <div className={cx('option-btn')}>
                <button className={cx('save-btn')} onClick={() => updateStudent()}>
                    Lưu thay đổi
                </button>
            </div>
        </div>

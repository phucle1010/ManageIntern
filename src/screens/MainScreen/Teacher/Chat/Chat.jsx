            ...
            <div className={cx('main-chat')}>
                <div className={cx('chat-container')}>
                    <div className={cx('chat-object')}>
                        <Avatar className={cx('chat-object-avatar')} src={students[chatContentIndex]?.image || "https://kenh14cdn.com/thumb_w/660/2020/6/6/583808735902613047891358253770177506705408n-15592399250171833547164-1591434336975414105459-crop-1591434346991904928321.jpg"} />
                        <span className={cx('chat-object-name')}>{students[chatContentIndex]?.fullName}</span>
                    </div>
                    <div className={cx('chat-content')}>
                        {mess.length > 0 &&
                            mess.map((message) => <Message key={message.id} message={message} user={students[chatContentIndex]} />)}

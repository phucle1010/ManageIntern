...
const ScoreTable = () => {
  ...
  const loadData = () => {
    ...
    axios
      .get('/teacher/student', {params: {academic, semester, searchStudent: searchStudent || null}, headers: {'Authorization' : token}})
      .then((res) => {
  ...
  useEffect(() => loadData(), [academic, semester, searchStudent]);
